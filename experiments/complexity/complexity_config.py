...
config['model']['diff_pool_net1']['parameters']['num_clusters1'] = int(2708*pool_ratios[0]) # 2708 is hard coded for cora!
config['model']['diff_pool_net1']['parameters']['num_clusters2'] = int(2708*pool_ratios[0]*pool_ratios[1]) # 2708 is hard coded for cora!
...
config['model']['diff_pool_net2']['parameters']['num_clusters1'] = int(2708*pool_ratios[0]) # 2708 is hard coded for cora!
config['model']['diff_pool_net2']['parameters']['num_clusters2'] = int(2708*pool_ratios[0]*pool_ratios[1]) # 2708 is hard coded for cora!
...
config['model']['topk']['parameters']['pool_ratios'] = pool_ratios2
...
config['model']['sagpool']['parameters']['pool_ratios'] = pool_ratios2
